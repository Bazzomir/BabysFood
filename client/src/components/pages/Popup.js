...
export function Popup(props) {
    ...
    return (
        <>
            <button id='iconsButton' onClick={() => { setModalShow(true); updateViews() }}>
...
//                 </Modal.Header>
//                 <Modal.Body>
//                     <Card style={{ width: '20rem', borderRadius: "3%" }}>
//                         <Card.Img style={{ borderTopLeftRadius: "3%", borderTopRightRadius: "2%" }} variant="top" src="https://media.istockphoto.com/photos/cheesy-pepperoni-pizza-picture-id938742222?k=20&m=938742222&s=612x612&w=0&h=X5AlEERlt4h86X7U7vlGz3bDaDDGQl4C3MuU99u2ZwQ=" />
//                         <Card.Body >
...
//     return (
//         <>
//             <Button style={{ position: "absolute", right: "3%", bottom: "3%" }} variant="success" onClick={() => { setModalShow(true); }}>
//                 <svg id="icons" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-chevron-double-right" viewBox="0 0 16 16">
//                     <path fillRule="evenodd" d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z" />
//                     <path fillRule="evenodd" d="M7.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L13.293 8 7.646 2.354a.5.5 0 0 1 0-.708z" />
//                 </svg>
