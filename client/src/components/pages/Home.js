...
export default function Home() {
    return (
        <Container >
            <Row >
                <Row><h3 id="h3Title">Fresh & New</h3></Row>
                <Col xs={4} >
                    <Card id="card">
                        <Card.Img id="cardImage" src={jajca} />
                        <Card.Body>
                            <Card.Title>
                                Card title
                            </Card.Title>
                            ...
                            <Button style={{ position: "absolute", right: "2%", bottom: "2%" }} variant="success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-double-right" viewBox="0 0 16 16">
            ...
            <Row >
                <Row><h3 id="h3Title">Most Popular Recipes</h3></Row>
                <Col xs={4} >
                    <Card id="card">
                        <Card.Img id="cardImage" src={jajca} />
                        <Card.Body>
